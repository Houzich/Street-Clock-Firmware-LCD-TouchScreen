 ...
 *      *** Do not modify ! ***
 *
 * Project: 'Street_Clock_F429' 
 * Target:  'Street_Clock_F429' 
 */
...
/* Keil::Device:STM32Cube HAL:DMA2D:1.7.9 */
...
/* Keil::Device:STM32Cube HAL:LTDC:1.7.9 */
...
/* Segger.MDK-Plus::Graphics:CORE:6.16.3 */
#define RTE_Graphics_Core               /* Graphics Core */
/* Segger.MDK-Plus::Graphics:Input Device:Touchscreen:6.16.3 */
