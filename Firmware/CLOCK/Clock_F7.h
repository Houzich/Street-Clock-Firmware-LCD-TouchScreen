...
#define MOTOR_1_Pin_Num	13
#define MOTOR_1_Pin	GPIO_PIN(MOTOR_1_Pin_Num)


//   <o> Port <0=>GPIOA <1=>GPIOB <2=>GPIOC <3=>GPIOD <4=>GPIOE <5=>GPIOF <6=>GPIOG
//   <7=>GPIOH <8=>GPIOI <9=>GPIOJ <10=>GPIOK
#define MOTOR_1_GPIO_Port GPIO_PORT(9)

#else
#define MOTOR_1_Pin_Num 0xFF
#endif

//</e>

// <e> MOTOR_2 Pin
#define MOTOR_2_Pin_En	1
#if (MOTOR_2_Pin_En	== 1)
//   <o> Pin <0=>P0 <1=>P1 <2=>P2 <3=>P3 <4=>P4 <5=>P5 <6=>P6
//       <7=>P7   <8=>P8   <9=>P9 <10=>P10 <11=>P11 <12=>P12 <13=>P13 <14=>P14 <15=>P15
#define MOTOR_2_Pin_Num	5
#define MOTOR_2_Pin	GPIO_PIN(MOTOR_2_Pin_Num)


//   <o> Port <0=>GPIOA <1=>GPIOB <2=>GPIOC <3=>GPIOD <4=>GPIOE <5=>GPIOF <6=>GPIOG
//   <7=>GPIOH <8=>GPIOI <9=>GPIOJ <10=>GPIOK
#define MOTOR_2_GPIO_Port GPIO_PORT(9)


#else
#define MOTOR_2_Pin_Num 0xFF
#endif
//</e>
...
//   <o> Pin <0=>P0 <1=>P1 <2=>P2 <3=>P3 <4=>P4 <5=>P5 <6=>P6
//       <7=>P7   <8=>P8   <9=>P9 <10=>P10 <11=>P11 <12=>P12 <13=>P13 <14=>P14 <15=>P15
#define HIGHT_LIGHT_Pin_Num	13
#define HIGHT_LIGHT_Pin	GPIO_PIN(HIGHT_LIGHT_Pin_Num)


//   <o> Port <0=>GPIOA <1=>GPIOB <2=>GPIOC <3=>GPIOD <4=>GPIOE <5=>GPIOF <6=>GPIOG
//   <7=>GPIOH <8=>GPIOI <9=>GPIOJ <10=>GPIOK
#define HIGHT_LIGHT_GPIO_Port GPIO_PORT(9)
...
#define TIME_TEST_MODE               120 //количество секунд тестового режима до блокировки модулю
#endif
...
#define CLOCK_MSG_OUT_QUEUE_OBJECTS 40
typedef struct {                                // object data type
  ClockMsgID id;
  char *str_lcd;
  int len;
